...
ud1 <- subset(pp, user_location_city==49389 & hotel_market==628 & srch_destination_id==8250 & hotel_cluster== 54)
ud2 <- subset(pp, user_location_city==49389 & hotel_market==628 & srch_destination_id==8250 & hotel_cluster==1)

ggplot() + 
geom_histogram(aes(col='54',x=ud1$orig_destination_distance),binwidth=0.1,alpha=0.5) +
geom_histogram(aes(col='1',x=ud2$orig_destination_distance),binwidth=0.1,alpha=0.5) + 
scale_x_continuous(breaks=seq(44,47,0.5)) +
coord_cartesian(xlim=c(44,47))
