...
ud1 <- subset(train_13,hotel_market==1532 & user_location_city==26232 & hotel_cluster==65)
ud2 <- subset(train_13,hotel_market==1532 & user_location_city==26232 & hotel_cluster== 34)
