...
ud1 <- subset(train_13,hotel_market==365 & user_location_city==24103 & srch_destination_id==8254 & hotel_cluster==91)
ud2 <- subset(train_13,hotel_market==365 & user_location_city==24103 & srch_destination_id==8254 &  hotel_cluster== 50)
