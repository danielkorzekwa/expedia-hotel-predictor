...
s <- subset(train_13,  srch_destination_id==12217 )
...
s61 <- subset(test_all,    hotel_cluster== 23 & srch_destination_id==12217 & is_booking==1 )
s81 <- subset(test_all,   hotel_cluster==  21 &  srch_destination_id==12217 & is_booking==1)
...
s <- subset(pp,r1==4 & hotel_cluster==6 & p1==1 & hotel_continent==2 & hotel_market==365 & srch_destination_id==12603)
