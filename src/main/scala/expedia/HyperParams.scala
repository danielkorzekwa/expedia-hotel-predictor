...
"expedia.model.marketdest.segmentSizeWeight" -> 0,
  ...
  def createParamsCont3(): HyperParams = {
    HyperParams(Map(
        "expedia.model.marketmodel.segmentSizeWeight" -> 1,
...
"expedia.model.marketdest.segmentSizeWeight" -> 1,
  ...
  def createParamsCont4(): HyperParams = {
    HyperParams(Map(
      "expedia.model.country.isBookingWeight" -> 1,
      "expedia.model.countryuser.isBookingWeight" -> 1,
      "expedia.model.dest.isBookingWeight" -> 1,
  ...
  def createParamsCont2Country198():HyperParams = {
    HyperParams(Map(
          "expedia.model.country.isBookingWeight" -> 1,
      "expedia.model.countryuser.isBookingWeight" -> 1,
      "expedia.model.dest.isBookingWeight" -> 1,
