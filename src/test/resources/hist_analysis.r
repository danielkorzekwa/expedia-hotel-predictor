...
s <- subset(pp,  srch_destination_id==12217 )
...
s61 <- subset(train_13,    hotel_cluster== 19 & srch_destination_id==12217 & is_booking==1 )
s81 <- subset(train_13,   hotel_cluster==  21 &  srch_destination_id==12217 & is_booking==1)
